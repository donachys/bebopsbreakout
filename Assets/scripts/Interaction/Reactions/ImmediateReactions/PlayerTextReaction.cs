...
public class PlayerTextReaction : Reaction
{
    ...
    private PlayerTextManager textManager;            // Reference to the component to display the text.


    protected override void SpecificInit()
    {
        textManager = FindObjectOfType<PlayerTextManager> ();
    }
